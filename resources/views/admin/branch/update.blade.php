    ...
    <div class="container">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Sửa chi nhánh</h6>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="note" id="note" rows="3">{{ $data->note }}</textarea>
                                    @if($errors->has('note'))
                                        <span class="text-danger error-text">
                                        {{$errors->first('note')}}
                                    </span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 form-tags">
                                    <select class="form-control" name="active" id="active">
                                        <option value="true" {{ $data->active == 1 ? 'selected':''}}>Có</option>
                                        <option value="false" {{ $data->active == 0 ? 'selected':''}}>Không</option>
                                    </select>
                                </div>
                            </div>
