                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 col-12">
                            <div class="images">
                                <img src="images/about-us-1.jpg" alt="story">
                            </div>
                        </div>
                        <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12 col-12">
                            <div class="story-detail">
                                <h2 class="special-heading">Our Story</h2>
                ...
                <div class="gallery-content">
                    <div class="row">
                        <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12">
                            <div class="row">
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                    <div class="images">
                                        <img src="images/about-us-gallery-1.jpg" alt="gallery-images">
                                        <div class="overlay"></div>
                                        <div class="gallery-zoom">
                                            <a href="images/about-us-gallery-1.jpg" data-fancybox="gallery" class="gallery-elements">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-12">
                                    <div class="images">
                                        <img src="images/about-us-gallery-2.jpg" alt="gallery-images">
                                        <div class="overlay"></div>
                                        <div class="gallery-zoom">
                                            <a href="images/about-us-gallery-2.jpg" data-fancybox="gallery" class="gallery-elements">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-12">
                                    <div class="images">
                                        <img src="images/about-us-gallery-3.jpg" alt="gallery-images">
                                        <div class="overlay"></div>
                                        <div class="gallery-zoom">
                                            <a href="images/about-us-gallery-3.jpg" data-fancybox="gallery" class="gallery-elements">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                    <div class="images">
                                        <img src="images/about-us-gallery-4.jpg" alt="gallery-images">
                                        <div class="overlay"></div>
                                        <div class="gallery-zoom">
                                            <a href="images/about-us-gallery-4.jpg" data-fancybox="gallery" class="gallery-elements">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                            <div class="images">
                                <img src="images/about-us-gallery-5.jpg" alt="gallery-images">
                                <div class="overlay"></div>
                                <div class="gallery-zoom">
                                    <a href="images/about-us-gallery-5.jpg" data-fancybox="gallery" class="gallery-elements">
                                    </a>
                                </div>
                            </div>
                        </div>
