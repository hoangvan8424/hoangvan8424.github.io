<div class="modal" role="dialog" data-backdrop="static" id="form-dangky" style="display:none;"> <!-- popup đăng ký -->
	<div class="modal-dialog modal-dialog-scrollable" role="document"> <!-- bắt đầu modal-dialog -->
	  	<div class="modal-content"> <!-- bắt đầu modal content -->

	  		<button type="button" class="close" data-dismiss="modal" aria-label="Close"> <!-- bắt đầu button close -->
                <i class="fas fa-times"></i>
            </button> <!-- kết thúc button close -->

	    	<ul class="nav nav-tabs"> <!-- bắt đầu thanh nav -->
				<li class="nav-item li-chung">
					<button type="button" class="btn btn-link bt-dn" id="dn-2">Đăng nhập</button>
				</li>
	    	...
	    	<div class="modal-body"> <!-- bắt đầu modal-body -->		    		
				<form name="dangky" action="register.php" method="POST" onsubmit="return validateForm()"> <!-- bắt đầu form -->
					...
					<div class="input-group mb-3"> <!-- repassword -->
						<div class="input-group-prepend">
							<span class="input-group-text">
								<i class="fas fa-unlock-alt"></i>
							</span>
					...
					<div class="row mt-2"> <!-- điều khoản sử dụng -->
						<div class="col-12">
